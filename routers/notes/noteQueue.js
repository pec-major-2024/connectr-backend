...
// import NoteEmotion from "../../models/NoteEmotion";

const noteWorker = new Worker('note-queue', async (job) => {
    ...
    try {
        ...
        console.log({ probability_dict, most_common_words })
        ...
        // console.log("Note emotion saved successfully.");
    } catch (err) {
